  ...
  return (
    <main className="min-h-screen bg-zinc-950 flex flex-col items-center justify-center px-6 text-center">
      ...
      <p className="text-lg text-zinc-400 mb-10 max-w-md">
        Error 404. La página que estás buscando no existe, fue movida o está fuera de stock en nuestro inventario.
      </p>
      <Link 
        href="/"
        className="px-8 py-3 bg-sky-500 hover:bg-sky-400 text-white font-medium rounded-full transition-colors duration-300 shadow-lg shadow-sky-500/25"
      >
        Regresar al inicio
      </Link>
    </main>
